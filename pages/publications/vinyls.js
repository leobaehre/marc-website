...
export default function vinyls({ images }) {
  return (
    <div>
      <Head>
      ...
      >
        ...
        <div className="relative mx-auto container">
          <h1 className="text-white font-azo-sans-web text-6xl pb-4">Vinyls</h1>
              ...
              return (
                <>
                  <div className="w-48 h-48 rounded-lg overflow-hidden ">
                    <img
                      src={`/publications/vinyls/${image.name}`}
